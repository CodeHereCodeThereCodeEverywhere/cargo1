...
<div class="flex items-center justify-center w-full h-96 lg:max-w-1/2 ">
            <img class=" w-full h-full max-w-2xl" src="/Home/Solutions/Vector.png"/>
        </div>
        <div class="w-full lg:max-w-[456px] pl-[120px] flex flex-col fill-inherit bg-inherit ">
          {text.map((item) => (
              <div class="lg:max-w-lg flex flex-row justify-start">              
              <div>
