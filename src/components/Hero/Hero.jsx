...
function Hero() {
  return (
    <div className='mt-[113px] w-full justify-center flex h-[554px] '>
        <div className='max-w-[1296px] grid grid-cols-2 w-full '>
            <div className='max-w-1/2 relative '>
                <h1 className='text-left text-[72px] font-semibold leading-[108%] text-base-blue font-space '>
                ...
                <button className='p-[20px]  border rounded-xl bg-base-blue border-base-blue text-white mr-[20px]  whitespace-nowrap'>Подгответе пратка онлайн</button>
                <button className='p-[20px]  border border-base-blue rounded-xl whitespace-nowrap text-[16px] font-semibold'>Транспорт на  контейнери</button>
                </div>

            </div>
            <div className='max-w-1/2 relative flex z-0'>
